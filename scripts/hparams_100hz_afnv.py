...
# exp_id = f'lj_v250t250_af_online_kl1.0_bs{tts_batch_size}'
...
voc_model_id = exp_id + '_vocBS200_init375k'
tts_model_id = exp_id + ''
...
voc_init_weights_path = '/home/dawna/tts/qd212/models/WaveRNN/checkpoints/lj_v250t250_af_online_kl1.0_bs100_stepD2.wavernn/wave_step375K_weights.pyt' # initial weights, usually from a pretrained model
