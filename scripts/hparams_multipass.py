...
# exp_id = f'mp_lj_asup'
# exp_id = f'mp_lj'
exp_id = f'mp_lj_1fr_2tf_pretrainVC'
...
tts_init_weights_path_pass2 = '/home/dawna/tts/qd212/models/WaveRNN/checkpoints/mp_lj_pass2_BS20.tacotron/pass2/taco_step16K_weights.pyt'
