...
tts_updateP1, tts_updateP2 = True, False
...
# exp_id = f'mp_lj_p1N2{tts_updateP1}{tts_updateP2}_BS{tts_batch_size}a{tts_batch_acu}_moreSteps{_tts_adjust_steps}_p1fr_re4_xAOy1s1'

# tts_updateP1, tts_updateP2 = True, True
# exp_id = f'mp_lj_p1N2{tts_updateP1}{tts_updateP2}_BS{tts_batch_size}a{tts_batch_acu}_moreSteps{_tts_adjust_steps}_p1fr_re4_xAOy1s1'


# tts_mode_train_pass1 = 'teacher_forcing'

# exp_id = f'mp_lj_p1N2{tts_updateP1}{tts_updateP2}_BS{tts_batch_size}a{tts_batch_acu}_moreSteps{_tts_adjust_steps}_p1{tts_mode_train_pass1}_re4_xAOy1s1'
...
# exp_id = f'mp_lj_p1N2{tts_updateP1}{tts_updateP2}_p1{tts_mode_train_pass1}_xAy1s1_BS{tts_batch_size}a{tts_batch_acu}_moreSteps{_tts_adjust_steps}_re4'
