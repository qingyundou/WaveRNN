...
exp_id = f'mp_lj_afOffline{attn_loss_coeff}_tfInit_sched_nll1N2_p1N2{tts_updateP1}{tts_updateP2}_xAy1s1_BS{tts_batch_size}a{tts_batch_acu}_moreSteps{_tts_adjust_steps}_re4'
...
tts_schedule = [(2,  1e-3, 10_000 * _tmp,  tts_batch_size, [0.25, 0.25, 0.5]),   # progressive training schedule
                (2,  1e-3, 20_000 * _tmp,  tts_batch_size, [0.25, 0.25, 0.5]),   # (r, lr, step, batch_size, tts_pass2_input_prob_lst)
                (2,  5e-4, 30_000 * _tmp,  tts_batch_size, [0.05, 0.05, 0.9]),
                (2,  1e-4, 40_000 * _tmp,  tts_batch_size, [0.05, 0.05, 0.9])]
